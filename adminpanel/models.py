...
class MLModel(models.Model):
    ...
    # Path untuk teknis
    file_path = models.CharField(max_length=255, help_text="Path relatif ke file .pkl, cth: ml_models/miko_student_risk_pipeline.pkl")
    explainer_path = models.CharField(max_length=255, blank=True, null=True, help_text="Path ke file explainer .pkl (jika ada).")
    features_path = models.CharField(max_length=255, blank=True, null=True, help_text="Path ke file nama fitur .pkl (jika ada).")
    
    # URL untuk menghubungkan ke halaman prediksi
